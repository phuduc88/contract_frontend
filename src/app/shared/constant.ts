...
export const TIME_PICKERS = {
  Options: [
    { id: 1, value: moment().subtract(0, 'weeks').startOf('week').format('YYYY-MM-DD') + ';' + moment().subtract(0, 'weeks').endOf('week').format('YYYY-MM-DD'), text: 'Tuần này' },
    { id: 2, value: moment().subtract(1, 'weeks').startOf('week').format('YYYY-MM-DD') + ';' + moment().subtract(1, 'weeks').endOf('week').format('YYYY-MM-DD'), text: 'Tuần trước' },
    { id: 3, value: moment().subtract(0, 'months').startOf('month').format('YYYY-MM-DD') + ';' + moment().subtract(0, 'months').endOf('month').format('YYYY-MM-DD'), text: 'Tháng này' },
    { id: 4, value: moment().subtract(1, 'months').startOf('month').format('YYYY-MM-DD') + ';' + moment().subtract(1, 'months').endOf('month').format('YYYY-MM-DD'), text: 'Tháng trước' },
...
export function GetIcon(fileType) {
  const fileIcon = SIGNATURE.FILE_ICONS.find(c => fileType.indexOf(c.type) > -1);
  if (fileIcon) {
