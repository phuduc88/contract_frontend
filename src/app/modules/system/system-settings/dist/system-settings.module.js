...
var system_settings_routing_module_1 = require("./system-settings-routing.module");
var pages_1 = require("./pages");
var SystemSettingsModule = /** @class */ (function () {
    ...
    SystemSettingsModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                tabs_1.NzTabsModule,
                system_settings_routing_module_1.SystemSettingsRoutingModule,
                shared_module_1.SharedModule,
                ngx_mask_1.NgxMaskModule.forRoot(),
            ],
            declarations: [pages_1.HsmSettingFormComponent, pages_1.ApiContractSettingFormComponent],
