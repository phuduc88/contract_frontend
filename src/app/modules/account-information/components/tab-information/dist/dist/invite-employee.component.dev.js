...
function () {
  ...
  InviteEmployeeComponent.prototype.setCheckboxParentAll = function () {
    ...
    this.datas = this.datas.map(function (item) {
      return __assign(__assign({}, item), {
        check: _this.getCheckboxParent(item)
      });
    });
  };
  ...
  InviteEmployeeComponent.prototype.getCheckboxParent = function (data) {
    ...
    var childrensCheckCount = data.childrens.filter(function (x) {
      return x.check;
    }).length;
  ...
  InviteEmployeeComponent.prototype.parentCheck = function (event, id) {
    ...
    this.datas = this.datas.map(function (item) {
      return item.id === id ? __assign(__assign({}, item), {
        childrens: item.childrens.map(function (children) {
          return __assign(__assign({}, children), {
  ...
  InviteEmployeeComponent.prototype.childrenCheck = function (event, parentId, childrenId) {
    this.datas = this.datas.map(function (item) {
      return item.id === parentId ? __assign(__assign({}, item), {
        childrens: item.childrens.map(function (children) {
          return children.id === childrenId ? __assign(__assign({}, children), {
            check: event.target.checked
          }) : children;
        })
      }) : item;
  ...
  __decorate([core_1.Input()], InviteEmployeeComponent.prototype, "employeeInfo");

  InviteEmployeeComponent = __decorate([core_1.Component({
