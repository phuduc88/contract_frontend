...
var ManageTemplateDocumentsComponent = /** @class */ (function () {
    function ManageTemplateDocumentsComponent(modalService, documentTemplateService, documentTemplateDataService, signFlowService, sanitizer) {
        ...
        setTimeout(function () {
            _this.documentTemplateService
                ...
                if (_this.error.length > 0) {
                    ...
                    _this.documentTemplate.employeesSign = [];
                    _this.showSignatureFlowDialog(_this.documentTemplate);
                }
    ...
    ManageTemplateDocumentsComponent.prototype.showSignatureFlowDialog = function (documentSign) {
        var _this = this;
        var modal = this.modalService.create({
            ...
            nzContent: components_1.SignatureTemplateComponent,
        ...
        modal.afterClose.subscribe(function (result) {
            ...
            _this.documentTemplate = result;
            _this.currentStep = result.currentStep;
        });
    };
    ...
    ManageTemplateDocumentsComponent.prototype.handleUploadReceiverFile = function (data) {
        var _this = this;
        this.documentTemplateService
    ...
    ManageTemplateDocumentsComponent.prototype.handleFormSearch = function (formValue) {
    ...
    ManageTemplateDocumentsComponent.prototype.handleDeleteBookmark = function (_a) {
        ...
        var data = _a.data;
        this.overloading = true;
        this.documentTemplateDataService["delete"](data.documentTemplateId, data.recordUpLoad)
            .subscribe(function (res) {
            _this.overloading = false;
        });
    };
    ...
    ManageTemplateDocumentsComponent.prototype.handleQuickView = function (_a) {
        ...
        //     console.log(res);
        //   });
        this.signFlowService.getDetail("1104").subscribe(function (data) {
            _this.overloading = false;
            var srcUrl = _this.sanitizer.bypassSecurityTrustResourceUrl("data:application/pdf;base64," + data.filesSign[0].data);
            var modal = _this.modalService.create({
                nzClosable: true,
                nzTitle: "Tệp PDF",
                nzStyle: { top: "20px" },
                nzClassName: "iframe-viewer",
                nzKeyboard: false,
                nzContent: components_1.IframeViewerComponent,
                nzOnOk: function (data) { return console.log("Click ok", data); },
                nzComponentParams: {
                    srcUrl: srcUrl
                },
    ...
    ManageTemplateDocumentsComponent.prototype.handleDownloadFileTemplateReceiver = function () {
        var _this = this;
        this.overloading = true;
        this.parentStyle = {
            "z-index": 99999,
        ...
        this.documentTemplateService.downloadExcelReceiver().then(function (response) {
            var subfixFile = ".xlsx";
            var fileName = "M\u1EABu file d\u1EEF li\u1EC7u ng\u01B0\u1EDDi nh\u1EADn.xlsx";
            var mimeType = _this.getMimeType(subfixFile);
            download_file_1.download(fileName, response, mimeType);
            _this.overloading = false;
            _this.parentStyle = {};
    ...
    ManageTemplateDocumentsComponent.prototype.handleUploadFileReceiver = function (_a) {
        var _this = this;
        var file = _a.file;
        this.overloading = true;
        this.parentStyle = {
    ...
    ManageTemplateDocumentsComponent.prototype.handleEditDocumentTemplate = function (_a) {
        var _this = this;
        var data = _a.data;
        this.overloading = true;
        this.parentStyle = {
        ...
        this.documentTemplateService
            ...
            .subscribe(function (res) {
            _this.showSignatureFlowDialog(res);
            _this.overloading = false;
            _this.parentStyle = {};
        });
    };
